...
import profileImage from "@/assets/images/profile_pic.webp";
import CheckCircleIcon from "@/assets/icons/check-circle.svg";
import ArrowUpRightIcon from "@/assets/icons/arrow-up-right.svg";
import svdImage from "@/assets/images/svd.webp";
import mtlImage from "@/assets/images/mtl.webp";
import gapImage from "@/assets/images/gap.webp";
import mnfImage from "@/assets/images/mnf.webp";

export const metadata = {
  title: { absolute: "Soumyajit Gupta | ML Engineer & Applied AI Scientist" },
  description:
    "ML Engineer, NLP and LLM Researcher specializing in fair toxicity detection, scalable neural networks, and interpretable machine learning for computational sciences.",
  alternates: {
    canonical: "/",
  },
};
...
const HeroSection = () => {
  return (
     <section className="h-screen pt-20 md:pt-40 pb-20 relative z-0 overflow-x-clip" aria-label="Hero">
       <div className="absolute inset-0 [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_70%,transparent)]">
         ...
         <HeroOrbit
          ...
          spinDuration="6s"
         >
           <SparkleIcon className="size-8 text-emerald-300/20" aria-hidden="true" />
         </HeroOrbit>
         <HeroOrbit
          size={440}
          rotation={80}
          ...
          spinDuration="6s"
         >
           <SparkleIcon className="size-5 text-emerald-300/20" aria-hidden="true" />
         </HeroOrbit>
         <HeroOrbit
          size={500}
          rotation={20}
          ...
          spinDuration="6s"
         >
           <StarIcon className="size-12 text-emerald-300" aria-hidden="true" />
         </HeroOrbit>
         ...
         <HeroOrbit
          ...
          spinDuration="6s"
         >
           <SparkleIcon className="size-20 text-emerald-300/20" aria-hidden="true" />
         </HeroOrbit>
         <HeroOrbit size={590} rotation={100} shouldOrbit orbitDuration="40s">
           <StarIcon className="size-8 text-emerald-300" aria-hidden="true" />
         </HeroOrbit>
         ...
         <HeroOrbit
          ...
          spinDuration="6s"
         >
           <SparkleIcon className="size-28 text-emerald-300/20" aria-hidden="true" />
         </HeroOrbit>
         ...
         <HeroOrbit
          ...
          spinDuration="6s"
         >
           <StarIcon className="size-28 text-emerald-300" aria-hidden="true" />
         </HeroOrbit>
       </div>
         ...
         <div className="flex flex-col items-center">
             <figure>
                <Image
                  ...
                  alt="Soumyajit Gupta avatar peeking from behind a laptop"
                  width={100}
                  height={100}
                  sizes="100px"
                  priority
           ...
           <div className="max-w-xl mx-auto">
            ...
            <div className="flex flex-col justify-center items-center mt-4 gap-8">
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 border border-white bg-white text-gray-900 h-12 px-6 rounded-xl min-h-[48px]"
              >
              ...
              <a
                ...
                className="flex items-center justify-center border border-white/50 bg-white/10 size-16 rounded-full animate-bounce"
              >
                <ArrowDown className="size-8" aria-hidden="true" />
              </a>
           </div>
         </div>
       </div>
     ...
     <section className="py-20" id="about">
       <div className="container">
         <SectionHeader
          ...
          description="ML Engineer — NLP and LLM Researcher — Applied AI Scientist"
         />
             ...
             <div className="flex items-center flex-col md:flex-row w-full h-full">
               <div className="flex-1 items-center justify-center">
                 <p className="md:pl-6 pb-4">
                   ...
                   based in between Mumbai &amp; Kolkata, India. I&apos;m a
                   domain-driven neural network modeler and applied AI scientist
                   around natural language, imaging and computational sciences
                   problems.
                 </p>
                 <p className="md:pl-6 pb-4">
                 ...
                 <p className="md:pl-6 pb-4">
                   Presently I&apos;m working as an consulting AI Engineer for{" "}
                    <a
                   ...
                   for around 1.5 years. I&apos;m open to{" "}
                ...
                <div className="flex-1 flex items-center justify-center">
                  <figure className="size-60 rounded-full items-center overflow-hidden bg-cover bg-center">
                    <Image
                      src={profileImage}
                      alt="Soumyajit Gupta profile picture"
                      width={240}
                      height={240}
                      sizes="240px"
                      loading="lazy"
       ...
       <div className="container">
         <div className="flex flex-col items-center">
           ...
           />
            <Link
              href="/projects"
              className="mt-4 inline-flex items-center gap-2 border border-white bg-white text-gray-900 h-12 min-w-[48px] px-6 rounded-xl"
            >
              <ArrowUpRightIcon className="size-4" aria-hidden="true" />
              <span className="font-semibold">View All Projects</span>
            </Link>
         </div>
         <article className="mt-10 flex flex-col gap-20">
           {portfolioProjects
             .filter((p) => p.featured)
             .map((project, projectIndex) => (
               ...
               >
                  <div className="lg:grid lg:grid-cols-2 lg:gap-16">
                    <div>
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="bg-white text-gray-950 h-12 w-full px-6 rounded-xl font-semibold inline-flex items-center justify-center gap-2 mt-8 min-h-[48px]"
                      >
                 ...
                 <hr className="border-t-2 border-white/5 mt-4 md:mt-5" />
                  <ul aria-label={`${project.title} results`} className="flex flex-col gap-4 mt-4 md:mt-5">
